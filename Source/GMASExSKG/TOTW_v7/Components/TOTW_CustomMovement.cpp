// TOTW BASE MOVEMENT COMPONENT DERIVED FROM GMCE_ORGANICMOVEMENTCOMPONENT


#include "TOTW_CustomMovement.h"
#include "GMCExtendedLog.h"
#include "Engine/PackageMapClient.h"
#include "Kismet/GameplayStatics.h"

void UTOTW_CustomMovement::BindReplicationData_Implementation()
{
...
void UTOTW_CustomMovement::GenAncillaryTick_Implementation(float DeltaTime, bool bLocalMove,
...
void UTOTW_CustomMovement::GenPredictionTick_Implementation(float DeltaTime)
{
...
void UTOTW_CustomMovement::GenSimulationTick_Implementation(float DeltaTime)
{
...
void UTOTW_CustomMovement::PreLocalMoveExecution_Implementation(const FGMC_Move& LocalMove)
{
...
void UTOTW_CustomMovement::SV_PreRemoteMoveExecution_Implementation(const FGMC_Move& RemoteMove)
{
...
void UTOTW_CustomMovement::MovementUpdate_Implementation(float DeltaSeconds)
{
...
void UTOTW_CustomMovement::OnSolverChangedMode(FGameplayTag NewMode, FGameplayTag OldMode)
{
...
void UTOTW_CustomMovement::Respawn()
{
...
void UTOTW_CustomMovement::Respawn_Internal()
{
...
void UTOTW_CustomMovement::CL_SetRespawnLocation_Implementation(const FTransform& TargetTransform)
{
...
void UTOTW_CustomMovement::GetRespawnLocation_Implementation(FTransform& OutTransform)
{
