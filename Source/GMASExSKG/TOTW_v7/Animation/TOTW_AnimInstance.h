...
#include "TOTW_AnimInstance.generated.h"

/**
 * 
 */
UCLASS()
class GMASEXSKG_API UTOTW_AnimInstance : public UGMCAbilityAnimInstance
{
	GENERATED_BODY()
...
public:
	...
	UGMASExSKGMovementComponent* MovementComponent;
