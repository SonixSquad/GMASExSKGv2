// TOTW BASE ANIM INSTANCE DERIVED FROM GMC_AbilityAnimInstance


#include "TOTW_AnimInstance.h"

void UTOTW_AnimInstance::ObtainComponents()
{
...
void UTOTW_AnimInstance::NativeInitializeAnimation()
{
...
void UTOTW_AnimInstance::NativeBeginPlay()
{
...
void UTOTW_AnimInstance::NativeUpdateAnimation(float DeltaSeconds)
{
